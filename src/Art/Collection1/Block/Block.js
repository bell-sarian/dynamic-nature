...
export default function Block(props) {
    ...
    let keyframesHorizon = `@-webkit-keyframes ${animationName} {
    ...
    let keyframesOcean = `@-webkit-keyframes ${animationName} {
        0%   { background-color: ${props.blockColor}; }
    ...
    return (React.createElement("div", { className: "block-container block-" + props.blockNumber + "-" + props.blockSubNumber, onMouseEnter: handleMouseEnter, onMouseLeave: handleMouseLeave, style: styles, key: props.blockNumber }));
}
