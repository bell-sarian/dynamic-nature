...
export default function Collection1() {
    ...
    return (React.createElement("div", null,
        React.createElement("div", { className: "ocean-sunset-container" },
            starBool ? React.createElement(Stars, null) : null,
            React.createElement(Sun, { sunStyle: sunStyle }),
        ...
        React.createElement("div", { className: "time-of-day-select-container" },
            React.createElement(Dropdown, { items: options, onChange: handleTimeOfDayChange })),
        React.createElement("div", { onClick: () => setModalOpen(true), className: "info-button-container" },
            React.createElement(InfoButton, null)),
        React.createElement(Modal, { setModalOpen: setModalOpen, content: content, modalOpen: modalOpen })));
}
